...
int createLargeLeftTable()
{
    ...
    // 1. Create Table
    std::cout << std::endl
              << "****Create Large Left Table****" << std::endl;
...
int createLargeLeftTable2()
{
    ...
    // 1. Create Table
    std::cout << std::endl
              << "****Create Large Left2 Table****" << std::endl;
...
int createLeftVarCharTable()
{
    ...
    // 1. Create Table
    std::cout << std::endl
              << "****Create Left VarChar Table****" << std::endl;
...
int createLargeRightTable()
{
    ...
    // 1. Create Table
    std::cout << std::endl
              << "****Create Large Right Table****" << std::endl;
...
int createLargeRightTable2()
{
    ...
    // 1. Create Table
    std::cout << std::endl
              << "****Create Large Right2 Table****" << std::endl;
...
int createRightVarCharTable()
{
    ...
    // 1. Create Table
    std::cout << std::endl
              << "****Create Right VarChar Table****" << std::endl;
...
void prepareLeftTuple(int attributeCount, unsigned char *nullAttributesIndicator, const int a, const int b, const float c,
                      void *buf)
{
    int offset = 0;
